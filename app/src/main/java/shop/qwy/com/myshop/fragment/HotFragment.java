    ...
    private void showData() {
        switch (state) {
            case STATE_NORMAL:
                ...
                mRecycleView.setAdapter(wearsAdapter);
                ...
                break;
            case STATE_REFREH:
                wearsAdapter.clearData();
                wearsAdapter.addData(datas);

                mRecycleView.scrollToPosition(0);
                mRefreshView.finishRefresh();
                break;
            case STATE_MORE:
                wearsAdapter.addData(wearsAdapter.getDatas().size(),datas);

                mRecycleView.scrollToPosition(wearsAdapter.getDatas().size());
                mRefreshView.finishRefreshLoadMore();
                break;
        }
    }
